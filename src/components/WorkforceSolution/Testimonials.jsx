  ...
  return (
    <section id="testimonials" className="bg-white py-16 md:py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-xs font-semibold tracking-widest uppercase mb-3 text-[#f5a623]">What Our Clients Say</p>
          <h2 className="font-heading font-bold text-3xl md:text-4xl text-[#0f2a52]">Trusted by Businesses Worldwide</h2>
        </div>
          ...
          {testimonials.map(({ name, industry, quote, person, company }, i) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <p className="font-heading font-bold text-[#0f2a52] text-lg leading-none">{name}</p>
                  <p className="text-[#5a6472] text-xs tracking-widest uppercase mt-1">{industry}</p>
                </div>
                <span className="text-7xl font-serif leading-none text-gray-100 select-none -mt-2" aria-hidden="true">"</span>
              </div>

              <p className="text-[#5a6472] text-sm leading-relaxed flex-1">"{quote}"</p>
              ...
              <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                ...
                <div>
                  <p className="font-heading font-semibold text-[#0f2a52] text-m leading-none">{person}</p>
                  <p className="text-[#5a6472] text-xs mt-1">{company}</p>
                </div>
              </div>
            </div>
          ))}
